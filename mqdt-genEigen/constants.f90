...
!  use, intrinsic :: ieee_arithmetic, only: IEEE_Value, IEEE_QUIET_NAN, IEEE_IS_NAN
  ...
  !integer, parameter :: long = kind(1.q0) ! quadruple does not work for lapack.
  !integer, parameter :: long = selected_real_kind(16) !, 307) ! for high dimension
  integer, parameter :: long = kind(1.d0) ! to be compatible to lapack !!! selected_real_kind(16) !, 307) ! for high dimension
  integer, parameter :: sp = kind( 1.0 )
  integer, parameter :: dp = kind( 1.0d0 )
  !integer, parameter :: wp = dp
  integer, parameter :: wp = long
  integer, parameter :: flxp = selected_real_kind(16) !, 307) ! for high dimension
